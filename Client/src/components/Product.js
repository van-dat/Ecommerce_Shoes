...
import { Show } from "../store/appSlice";
import { getOneProduct } from "../store/action";
      ...
      {data?.map((i, index) => (
        ...
        >
          <div className="p-2 w-full ">
            <div className="w-full overflow-hidden h-[245px]">
              <img
                src={i.thumbnail[1]}
                alt="thumbnail"
                className="w-full  object-contain  scale-100 hover:scale-110 ease-in-out duration-2000  cursor-pointer"
